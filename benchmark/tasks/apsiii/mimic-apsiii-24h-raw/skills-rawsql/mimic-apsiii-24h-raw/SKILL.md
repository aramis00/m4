...
SELECT
    ...
    , COALESCE(hr_score, 0) AS hr_score
    , COALESCE(mbp_score, 0) AS mbp_score
    , COALESCE(temp_score, 0) AS temp_score
    , COALESCE(resp_rate_score, 0) AS resp_rate_score
    , COALESCE(pao2_aado2_score, 0) AS pao2_aado2_score
    , COALESCE(hematocrit_score, 0) AS hematocrit_score
    , COALESCE(wbc_score, 0) AS wbc_score
    , COALESCE(creatinine_score, 0) AS creatinine_score
    , COALESCE(uo_score, 0) AS uo_score
    , COALESCE(bun_score, 0) AS bun_score
    , COALESCE(sodium_score, 0) AS sodium_score
    , COALESCE(albumin_score, 0) AS albumin_score
    , COALESCE(bilirubin_score, 0) AS bilirubin_score
    , COALESCE(glucose_score, 0) AS glucose_score
    , COALESCE(acidbase_score, 0) AS acidbase_score
